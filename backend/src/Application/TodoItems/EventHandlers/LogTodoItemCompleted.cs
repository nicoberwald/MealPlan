using SmartMealPlanner.Domain.Events;
using Microsoft.Extensions.Logging;

namespace SmartMealPlanner.Application.TodoItems.EventHandlers;
...
public class LogTodoItemCompleted : INotificationHandler<TodoItemCompletedEvent>
{
    ...
    {
        _logger.LogInformation("SmartMealPlanner Domain Event: {DomainEvent}", notification.GetType().Name);
