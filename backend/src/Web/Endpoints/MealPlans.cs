...
public class MealPlans : IEndpointGroup
{
    public static void Map(RouteGroupBuilder groupBuilder)
    {
        ...
        groupBuilder.MapGet(GetShoppingList, "/{id}/shopping-list");
    }
    ...
    public static async Task<Ok<IEnumerable<ShoppingListItemDto>>> GetShoppingList(int id, ISender sender)
    {
        var items = await sender.Send(new GetShoppingListQuery(id));
